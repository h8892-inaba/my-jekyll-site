...
## 資料
- [1日目「RTで自分のアイディアを実現しよう」](http://www.openrtm.org/OpenRTM-aist/download/resume/080820/080820.pdf)
- [2日目「ロボットはどのように動いているのか」](http://www.openrtm.org/OpenRTM-aist/download/resume/080820/080821.pdf)

# プログラム
<table class="table-alt">
  <tr>
    <th>></th>
    <th>CENTER:**8月20日(初日)午後 (3h)**</th>
  </tr>
  <tr>
