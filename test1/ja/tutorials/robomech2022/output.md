...
<table class="table-alt">
  ...
  <tr>
    <td>15:40 -17:00</td>
    <td>第5部：Choreonoid入門 <br> - 担当：宮本信彦 氏(産総研) <br> - 概要：ロボット用シミュレーションソフトウェアChoreonoidと連携するRTCを作成方法を解説します。<br> <a href="/ja/node/7150">チュートリアル(第5部)</a> <br>**講義資料**:<a href="/sites/default/files/7113/Choreonoid入門.pdf">Choreonoid入門.pdf</a></td>
  </tr>
</table>
