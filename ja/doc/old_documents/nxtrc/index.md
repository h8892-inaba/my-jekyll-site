...
- 参考
  - [RTコンポーネント作成(LEGO Mindstorm編)]({{ site.baseurl }}/ja/doc/casestudy/rtc_development/rtc_development_lego_mindstorm)
...
※詳細は[RTコンポーネント作成(LEGO Mindstorm編)]({{ site.baseurl }}/ja/doc/casestudy/rtc_development/rtc_development_lego_mindstorm)マニュアルでごご覧ください。
...
- 手順
  ...
  - [こちら]({{ site.baseurl }}/ja/doc/casestudy/rtc_development/rtc_development_lego_mindstorm/midstorm_nxt_setup)を参考にPCとLEGO MindstormをBluetooth、又はUSB接続してください。
