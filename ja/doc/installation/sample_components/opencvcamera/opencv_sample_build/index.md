...
- OpenRTM-aistを[一括インストールスクリプト]({{ site.baseurl }}/ja/doc/appendix/bulk_installation_script)を用いてインストールしてください。(以下の手順の実行にはC++版とPython版が必要になります。また、実際に動作させる場合にはOpenrtpが必要になることが多いかと思われます。それに合わせてオプションを指定してください。)  例えば
```
