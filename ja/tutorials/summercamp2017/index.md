...
<table class="table-alt">
  ...
  <tr>
    <td>09:30 - 10:00</td>
    <td>RTミドルウェアツール紹介１：<br>RT Shellを使った効率の良いRTシステム運用<br> **講義資料**:<a href="./rtshell_2017.pdf">rtshell_2017.pdf </a></td>
    <td>ビグス　ジェフ<br>(産業技術総合研究所)</td>
  </tr>
  <tr>
    <td>10:00 - 10:30</td>
    <td>RTミドルウェアツール紹介2：<br>マネージャーやコンポーネントのコンポジット化<br> **講義資料**:<a href="./2017SummerCamp-03.pdf">2017SummerCamp-03.pdf</a> , <a href="./2017SummerCamp-03.zip">2017SummerCamp-03.zip</a></td>
    <td>宮本信彦<br>(産業技術総合研究所)</td>
  </tr>
  <tr>
    <td>10:30 - 11:00</td>
    <td>RTミドルウェアツール紹介3：<br>効率の良いRTコンポーネント開発のための支援ツール<br> **講義資料**:<a href="./2017SummerCamp-04.pdf">2017SummerCamp-04.pdf</a></td>
  ...
  <tr>
    <td>11:30 - 12:00</td>
    <td>RTシステム構築事例紹介2：<br>つかえるRTコンポーネントの紹介(課題)<br> **講義資料**:<a href="./有用なRTCの紹介.pdf">有用なRTCの紹介.pdf</a></td>
...
- 参加登録するまえに当Webページのユーザ登録をお願いします。[ユーザ登録はこちら]()（リンク切れです）
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/36yhQyanQqjTuB"
%}
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/5Jqgp74QvDHljt"
%}
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/KNqbt5doCx2SMW"
%}
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/ss4gkNpadO3e9u"
%}
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/CyAg7IDBB1lFPW"
%}
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/8rsQrkw6Zanf1H"
%}
...
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/MTBgvWqWOaQPKM"
%}
...
- **課題**: 自撮りロボット！
- [プロジェクトページ](/ja/project/SummerCamp2017_group1)（Projectページはリンク切れです）

<!-- Invalid YouTube URL: http://www.slideshare.net/78651769 -->
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/7oBqna57UZ4mY5"
%}
...
- [プロジェクトページ](/ja/project/SummerCamp2017_group2)（Projectページはリンク切れです）

<!-- Invalid YouTube URL: http://www.slideshare.net/78651760 -->
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/pEbRC6TxCSA6Mz"
%}
...
- **課題**: ロボットクエスト
- [プロジェクトページ](/ja/project/SummerCamp2017_group3)（Projectページはリンク切れです） 

<!-- Invalid YouTube URL: http://www.slideshare.net/78651746 -->
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/GTu15ndJeCZSKD"
%}
...
- **課題**: 名刺交換ロボット
- [プロジェクトページ](/ja/project/SummerCamp2017_group4)（Projectページはリンク切れです）

<!-- Invalid YouTube URL: http://www.slideshare.net/78651727 -->
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/mRUGkGbmfkHPBw"
%}
...
- **課題**: ちょっと安全なピッキングロボットシステム
  - 
  - 
- [プロジェクトページ](/ja/project/SummerCamp2017_group5)（Projectページはリンク切れです）

<!-- Invalid YouTube URL: http://www.slideshare.net/79007428 -->
{% include slideshare.html
   src="https://www.slideshare.net/slideshow/embed_code/key/tnWZS6vAjRSiB8"
%}
...
## 講習会の様子
<div align="center"><a href="sc2017_1.JPG"><img src="sc2017_1.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_2.JPG"><img src="sc2017_2.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_3.JPG"><img src="sc2017_3.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_5.JPG"><img src="sc2017_5.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_6.JPG"><img src="sc2017_6.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_7.JPG"><img src="sc2017_7.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_8.JPG"><img src="sc2017_8.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_9.JPG"><img src="sc2017_9.JPG" width="60%;"></a></div>
<br>

<div align="center"><a href="sc2017_10.JPG"><img src="sc2017_10.JPG" width="60%;"></a></div>
<br>
