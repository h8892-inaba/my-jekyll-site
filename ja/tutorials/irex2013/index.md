...
<table class="table-alt">
  ...
  <tr>
    <td>11:00 -11:50</td>
    <td>**第2部：RTコンポーネントの作成入門** <br> **担当**：安藤慶昭氏 (産総研)<br> **概要**：RTCBuilderを使用したRTコンポーネントの作成方法を実習形式で体験していただきます。 <br> <a href="{{ site.baseurl }}/ja/doc/casestudy/opencv_comp_development/opencv_winxp_rtmtools_vc2010">講義資料</a></td>
  </tr>
  <tr>
    <td>11:50 -12:00</td>
    <td>質疑応答・意見交換</td>
