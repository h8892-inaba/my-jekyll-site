...
<table class="table-alt">
  <tr>
    <td>Installer for Windows<br> (OpenRTM-aist C++, Python, Java version<br> and Including OpenRTP, rtshell (4.1.0))</td>
...
- <span style="color:red;">* Python 2.7.10 recommended. 2.7.11 may require setting environment variables such as PYTHONPATH.</span>;
- <span style="color:red;">* Please delete old rtshell beforehand.</span>;
...
<table class="table-alt">
  <tr>
    <td>Installer for Windows<br> (OpenRTM-aist C++, Python, Java version<br> And OpenRTP, including rtshell (4.1.0))</td>
...
### (G)Linux package
<!-- ***Linux パッケージ -->
Distribution packages for Ubuntu, Debian, and Fedora are distributed on the repository server on openrtm.org.
...
<table class="table-alt">
  <tr>
    ...
    <th>Bulk Installation Script</th>
  </tr>
  <tr>
    <th>Ubuntu 14.04 (trusty) i386/amd64/arm64 <br> Ubuntu 16.04 (xenial) i386/amd64/arm64 <br> Ubuntu 16.10 (yakkety) i386/amd64 <br> Ubuntu 17.04 (zesty) i386/amd64 <br> Ubuntu 17.10 (artful) i386/amd64</th>
    <th><a href="http://svn.openrtm.org/OpenRTM-aist/trunk/OpenRTM-aist/build/pkg_install_ubuntu.sh">pkg_install_ubuntu.sh </a></th>
  </tr>
  <tr>
...
<table class="table-alt">
  ...
  <tr>
    <td>Python version source code(Win32)</td>
