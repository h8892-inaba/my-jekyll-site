...
- [ROBOMECH2022RTM講習会]({{ site.baseurl }}/en/tutorials/robomech2022) (移動ロボット実機を制御するコンポーネントの作成)
...
<table class="table-alt">
  ...
  <tr>
    <td>16:00-17:30</td>
    <td>RTシステムモデル化実習</td>
    <td>グループに分かれて構築するしすてむの<br>モデル化を行います。</td>
  </tr>
  <tr>
    <td>18:00-</td>
    <td>懇親会</td>
...
<table class="table-alt">
  <tr>
    <th>8月22日(火) <a href="https://us02web.zoom.us/j/88504370244?pwd=WjB0S0I4ZHE1U2EvcWpZMVlkanA2QT09"><img src="zoom.png" width="20%;"></a></th>
    <th colspan="2">2日目</th>
  </tr>
  <tr>
    <td>9:30-10:10</td>
  ...
  <tr>
    <td>15:00-16:00</td>
    <td>開発目標システム発表</td>
    <td>今後開発するシステムに付いてグループごとに<br>発表してもらいます。</td>
  </tr>
  <tr>
    <td>16:00-18:00</td>
    <td>RTシステム構築実習1</td>
...
- **マニュアル，ドキュメント** → プロジェクトページに自分で格納
  ...
  - 過去のサマーキャンプやコンテストのプロジェクトを参照してください
    ...
    - [RTMコンテスト2022作品一覧](https://openrtm.org/openrtm/ja/contests/2022)(No corresponding English project page available.)(No corresponding English project page available.)(no_page)
...
- [利用可能なRTコンポーネントやツールについて](2023SummerCamp-03.pdf)
<!-- <nowiki> -->
...
- **課題**: 集荷ロボット
  - [プロジェクトページ](/ja/project/SummerCamp20231)(No corresponding English project page available.)(No corresponding English project page available.)(no_page)
...
- **課題**: 
  - [プロジェクトページ](/ja/project/SummerCamp20232)(No corresponding English project page available.)(No corresponding English project page available.)(no_page)
...
<div align="center"><a href="rtmsummercamp2023_05.jpg"><img src="rtmsummercamp2023_05.jpg" width="50%;"></a></div>
<br>
