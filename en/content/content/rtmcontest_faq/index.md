...
[RTミドルウエア(OpenRTM-aist)のホームページ]({{ site.baseurl }}/en/doc/aboutopenrtm)を参照ください。

### Q: RTミドルウエアのユーザメーリングリストに登録するには？
[RTミドルウエアのメーリングリスト]()(No corresponding page available.)のページを参照ください。

### Q: RTミドルウエアを使った開発で使用するプログラム言語は何ですか？
コンセプトとしては、いろいろな言語をサポートしたいと考えております。現時点で産総研からご提供可能なC++ 版、Java版、Python版を利用することができます。詳細は、[OpenRTM-aist諸元のページ]({{ site.baseurl }}/en/doc/aboutopenrtm/specification)、[プロジェクトのＲＴミドルウエアページ]()(No corresponding page available.)を参照ください。

### Q: コンポーネント化って具体的にはどうするの？
講習会資料を参考にしてください。 また、少し古い情報ですが、学習推論ライブラリを RTミドルウエアを使ってコンポーネント化した[学習推論コンポーネントの例]()(No corresponding page available.)を公開しております。参考にしていただければ幸いです。また、[過去のコンテスト作品]({{ site.baseurl }}/en/content/content)を参考にしてください。

### Q: すでに開発されているRTコンポーネントは？
[OpenRTM-aistのコンポーネントページ](http://www.openrtm.org/openrtm/ja/node/1546)(No corresponding English project page available.)(No corresponding English project page available.)を探してみてください。また、過去の資料も参考にしてください。

- [RTミドルウエア技術カタログ2010]()(No corresponding page available.)　（産総研）
- [NEDO国際ロボット展2009：知能化モジュール集](http://www.nedo.go.jp/library/pamphlets/ZZ_pamphlets_02kikai_chinou.html) (NEDO)
- [RTミドルウエア技術カタログ2009]()(No corresponding page available.)　（産総研）

### Q: RTミドルウエアを勉強するには？
まずは、[OpenRTM-aistを10分で始めよう！]()(No corresponding page available.)を体験してみてください。
毎年春のロボティクス・メカトロニクス講演会にて一日講習会を、夏には産総研つくばセンターにて
合宿制のサマーキャンプを開催しておりますので、是非、ご参加下さい。
ある程度の人数を集めていただき、講師の旅費を工面いただければ、出張講習も可能です。
ご相談ください。

過去の講習会情報や資料が**[講習会ページ]({{ site.baseurl }}/en/tutorials)**にまとめてありますので、自習も可能です。
