...
<a href="/contests/2024"><img src="../images/contest2013_worklist.png" width="10%;"></a>(No corresponding English project page available.)(No corresponding English project page available.)
...
[計測自動制御学会(SICE)](http://www.sice.jp)のシステムインテグレーション部門講演会 (SI2024) の特別セッションとしての開催を予定しております。詳細が決まり次第こちらのページでご案内いたします。

- 日時: 2024年12月18日(水) 09:30-13:15
- 場所: マリオス18F会議室188  
  - [マリオスへのアクセス](https://www.malios.co.jp/access/)
...
## オンライン参加リンク
RTMコンテスト当日 (12/18 9:30-13:00頃) のみ有効。どなたでも視聴できます。

<!-- &ref(zoom.png,50%,url=https://us02web.zoom.us/j/86086364722?pwd=AEDOr9mnsZauxcvuSd3PZa91GbWlKp.1); -->
...
<table class="table-alt">
  ...
  <tr>
    <td>si2024-1024</td>
    <td>9:30-9:45</td>
    <td><a href="/ja/project/contest2024-si2024-1024">複数台ロボットのリアルタイム状態監視を可能にする 柔軟なモニタリングサービスの提案 </a>(No corresponding English project page available.)(No corresponding English project page available.)</td>
    <td>大竹　徹, 大原　賢一 (名城大学)</td>
    <td>ロボットサービスイニシアチブ賞,チェンジビジョン賞</td>
  </tr>
  <tr>
    <td>si2024-0741</td>
    <td>9:45-10:00</td>
    <td><a href="/ja/project/contest2024-si2024-0741">環境適応型ロボットのための進化型モジュール構成に関する検討</a>(No corresponding English project page available.)(No corresponding English project page available.)</td>
    <td>片山　拓海, 坂本　康輔 (中央大学) <br> 鈴木　大和, 國井　康晴 (中央大学)</td>
    <td>RTM技術開発賞</td>
  </tr>
  <tr>
    <td>si2024-0576</td>
    <td>10:00-10:15</td>
    <td><a href="/ja/project/contest2024-si2024-0576">映像と音声を用いて飲用体験を向上させるデバイス</a>(No corresponding English project page available.)(No corresponding English project page available.)</td>
    <td>木村　美咲, 新　奈朋, 中村　円子<br>林　夢結, 村上　大河<br> (芝浦工業大学附属高等学校)<br> 藤田　みずき (芝浦工業大学)<br> 山岡　佳代, 山川　翔馬, 渡部　正道<br> (芝浦工業大学附属中学高等学校)<br> 佐々木　毅(芝浦工業大学)<br></td>
    <td>グローバルアシスト賞</td>
  </tr>
  <tr>
    <td>si2024-0575</td>
    <td>10:15-10:30</td>
    <td><a href="/ja/project/contest2024-si2024-0575">カレンダー情報を用いた忘れ物チェッカの開発</a>(No corresponding English project page available.)(No corresponding English project page available.)</td>
    <td>竹本　莉子, 戸邊　綾香, 西川　璃子<br>山田　真礼, 山岡　佳代, 山川　翔馬<br>渡部　正道 (芝浦工業大学附属中学高等学校)<br>藤田　みずき (芝浦工業大学)<br>佐々木　毅 (芝浦工業大学)<br></td>
    <td>フレッシュマン賞,システムズエンジニアリング賞​,日本ロボット工業会賞</td>
  </tr>
  <tr>
    <td>si2024-0109</td>
    <td>10:30-10:45</td>
    <td><a href="/ja/project/contest2024-si2024-0109">洞窟の3次元点群を用いた図面化システムのRTコンポーネント開発</a>(No corresponding English project page available.)(No corresponding English project page available.)</td>
    <td>藤井　雄基, 戸田　雄一郎, <br> 松野　隆幸（岡山大学), <br></td>
    <td>最優秀賞 計測自動制御学会 RTミドルウェア賞 ,ベストサポート賞,SUGAR SWEET ROBOTICS賞</td>
  </tr>
  <tr>
    <td></td>
    <td>10:45-12:00頃</td>
...
<!-- |CENTER:160|CENTER:160|LEFT:600|LEFT:700|LEFT:200|c -->
<!-- |>|>|>|>|2024年12月18日 9:30-13:15| -->
<!-- |1H1-06| 10:45-11:00 | [[⽂章要約を⽤いたタイムスタンプ⾃動作成システム:/ja/node/7243]] |束⽥ 繁洸, 福⽥ 啓太, 佐々⽊彪雅 &br; （芝浦工業大学附属高等学校), &br; 山岡佳代, 横山浩司 &br; （芝浦工業大学附属中学高等学校）, &br; 佐々木毅（芝浦工業大学）| システムエンジニアリング賞、フレッシュマン賞 ​| -->
<!-- |1H1-07| 11:00-11:15 | [[GoogleMapAPIを用いた写真スポット提案システムの開発:/ja/node/7249]] |須⼭怜於, 須⼭莉於, ⽩⽯新太, &br; ⼤岩広空, 束⽥繁洸 &br;（芝浦工業大学附属高等学校), &br; 山岡佳代, 横山浩司 &br; （芝浦工業大学附属中学高等学校）, &br; 佐々木毅（芝浦工業大学）| ベストサポート賞  ​| -->
<!-- |1H1-08| 11:15-11:30 | [[異種ミドルウェア相互運用のための座標変換コンポーネントの開発:/ja/node/7250]] |木藤慈, 大原賢一 （名城大学）|  ​| -->
<!-- |1H1-09| 11:30-11:45 | [[wasanbonのためのシステム構築ツールRTSBuilder:/ja/node/7251]] |福田真斗, 加藤美沙, &br; 大原賢一（名城大学）|  ​| -->
...
これらのフィードバックを元に応募者が改良を加え、SI2024でのプレゼンテーションまでに、より良い作品になるようご協力ください。
...
- 冠賞スポンサー依頼・奨励賞申し込み書(修正版): (no_link)
  - Word版(修正版): (no_link)
- [奨励賞登録フォーム](https://forms.gle/vqZogZWknUHqfbb79)(GoogleFormに移動します)
<!-- - [[奨励賞登録フォーム>https://forms.office.com/r/XecETGiEhc]](MicrosoftFormsに移動します) -->
...
- **8月30日（金）**: エントリ〆切　（SI2024講演申込み〆切）
- **10月3日**: 原稿〆切（SI2024原稿〆切）
<!-- - ''10月25日（水）'': 原稿〆切（SI2024原稿〆切） -->
- **11月上旬頃**: ホームページにてソフトウエア登録開始（一般ユーザへの公開開始）
- **11月下旬**: 作品登録締め切り
- **11月下旬～12月18日**: オンライン評価期間 (一般ユーザによるオンライン評価期間)
- **12月18日**: SI2024会場にて、プレゼンテーションと表彰者発表　
- **12月19日**: SI2024授賞式にて最優秀者表彰

### 応募手順

- [SI2024への発表申込](https://sice-si.org/conf/si2024/)
申込セッションとして「特別OS：RTミドルウエアコンテスト2024」、講演の種類として「一般講演」をそれぞれ選択し、講演題目のところに開発したRTコンポーネントや関連技術の名称を、著者のところに開発者の情報をそれぞれ記入お願いいたします。学生さんがエントリする場合は**事前に指導教員の了承**を得るとともに、指導教員を共著者として登録いただくようお願いいたします。~
※申し込み締切日が決まってますので、**エントリー登録を決意した方はSI2024の講演申し込みを先に進めてください**。

- [SI2024への予稿原稿の投稿](https://sice-si.org/conf/si2024/)（9月下旬）~ //後で修正
投稿規定に従って、講演予稿集のための2～6ページの原稿を作成し、投稿ください。
- [SI2024への参加登録](https://sice-si.org/conf/si2024/) ~
...
が必要となります。特に、SI2024への参加には参加登録料が必要となりますことを予めご了承ください。また、SI2024の会場にてプレゼンテーションを行うことが求められます。
SI2024の申込方法、申込および原稿〆切および具体的な開催日時やプログラムは [SI2024のホームページ](https://sice-si.org/conf/si2024/) にてご確認下さい。
...
<!--（[応募作品](http://www.openrtm.org/openrtm/contests/2022)(No corresponding English project page available.)(No corresponding English project page available.)）-->
  - （[応募作品]()）(no_link)
- [RTミドルウエアコンテスト2023](/content/rtmcontest2023)(No corresponding English project page available.)(No corresponding English project page available.)  
<!--（[応募作品](http://www.openrtm.org/openrtm/contests/2023)(No corresponding English project page available.)(No corresponding English project page available.)）-->
  - （[応募作品]()）(no_link)
...
1. ボキャブラリ ''RTM contest 2024' を設定する
  - プロジェクト登録画面にボキャブラリと呼ばれるタグを設定する画面が現れますが、そこで **RTM contest 2024** を選択してください。これによりRTMコンテスト参加作品であることがわかります。
1. プロジェクト名をSIの発表タイトルとできるだけ同じ名前に設定する
  - 審査の都合上、SIの発表タイトルとプロジェクト名をひも付ける必要があります。可能であればSI2024での発表タイトルと同じ名前でプロジェクトの登録をお願いいたします。ただし、論文タイトルが 「○○の□□コンポーネントの実装」のようなものの場合、プロジェクト名は 「○○の□□コンポーネント」としていただいた方が、プロジェクトページとしては妥当かと思われます。発表タイトルとプロジェクトの関係がわかる程度でプロジェクト名を設定していただきますようよろしくお願いいたします。
1. プロジェクト情報「Short project name」をcontest2024_<番号>としてください．
...
http://openrtm.org/openrtm/ja/project/contest2024_X
となります。
...
- 入力フォームにしたがって作品タイトル、氏名、エントリー歴、奨励賞受賞歴（あり/なし）等を入力して下さい。[各種奨励賞](../rtmcontest2024-award)選考の参考とさせていただきます。

<!-- ** コンテスト当日の様子 -->


<!-- #ref(rtm2024_00.jpeg, 40%) -->
<!-- &br; -->
<!-- &br; -->
