<div align="left"><a href="/ja/node/4508"><img src="openlab2011logo.png" width="80%;" align="left"></a></div>
#contents
#clear
...
- 参加費：
  - 無料
- 事前登録：
  - **ホームページ（[http](//www.aist-openlab.jp::http://www.aist-openlab.jp)）からの事前来場登録（来場申し込み）とラボ事前予約が必要となります。**
- 交通機関：
...
****出展者**|[産総研・知能システム研究部門・栗原眞二、安藤慶昭**: http](//unit.aist.go.jp/is/index_j.html)
:**概要**|
...
****出展者**|[産総研・知能システム研究部門・栗原眞二・安藤慶昭**: http](//unit.aist.go.jp/is/index_j.html)、株式会社グローバルアシスト・坂本武志
:**概要**|
...
****出展者**|[産総研・知能システム研究部門・Geoffrey Biggs**: http](//unit.aist.go.jp/is/index_j.html)
:**概要**|
...
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/rtc_stage.jpg,center,70%); -->
<!-- CENTER:''RTC:Stage'' -->
<!-- #br -->

<!-- ***OpenHRI -->
<!-- :''出展者''|[[産総研・知能システム研究部門・松坂 要佐:http://unit.aist.go.jp/is/index_j.html]] -->
<!-- :''概要''| -->
...
****出展者**|[産総研・知能システム研究部門・安藤慶昭**: http](//unit.aist.go.jp/is/index_j.html)
:**概要**|
画像処理ライブラリとして広く利用されているOpenCV の様々な処理関数をRTコンポーネント化する際に、データ型・インター 
...
## 協力展示
### TECCO RTC
****出展者**|[株式会社ゴビ**: http](//www.go-v.co.jp/)
:**概要**|
株式会社ゴビ製のウェアラブルRFIDリーダ『TECCO』用RTコンポーネント.
TECCOで読取ったRFIDタグのデータを受信し、他のRTコンポーネントで利用できるように出力します.
:**特徴**|
- 読取ったRFIDタグのデータを時刻印付にて出力
- BluetoothのCOMポートはコンフィギュレーションにて変更可能
- ハンディタイプのような持ち替え動作は不要で、自然な動作でICタグを読み取ることが可能

<div align="center"><div align="center"><a href="TECCORTC.jpg"><img src="TECCORTC.jpg" width="50%;"></a></div>;</div>

### Android版OpenRTM
****出展者**|[株式会社 ウェルインテクノロジー**: http](//www.wellbean.net/) <br> [株式会社 未来技術研究所](http://www.ftl.co.jp/index.html)
:**概要**|
...
:**※**この開発は、独立行政法人科学技術振興機構の研究成果展開事業（先端計測分析技術・機器開発プログラム）による成果である。|開発課題名：　先端計測分析機器用共通ソフトウェアプラットフォームの開発 <br>チームリーダー名：　大阪大学教授　佐藤了平



<br>

<div align="center"><div align="center"><a href="ftl01.png"><img src="ftl01.png" width="50%;"></a></div>;</div>

<br>


### 共通カメラインタフェースに基づくコンポーネント群
****出展者**|[大阪大学新井研究室・大原賢一 先生**: http](//www-arailab.sys.es.osaka-u.ac.jp/)
:**概要**|
...
<div align="center"><div align="center"><a href="Cencept.jpg"><img src="Cencept.jpg" width="50%;"></a></div>;</div>

<br>

### タスク制御コンポーネントによる遠隔階層型ソフトウェアアーキテクチャ
****出展者**|[中央大学大学院國井研究室・小山順平 氏**: http](//www.hmsl.elect.chuo-u.ac.jp/)
:**概要**|
...
<div align="center"><div align="center"><a href="hernandez0625.png"><img src="hernandez0625.png" width="50%;"></a></div>;</div>

<br>

### 効率的なRTシステム開発および運用のための汎用入出力・情報処理コンポーネント群
****出展者**|[芝浦工業大学佐々木研究室・佐々木 毅 先生**: http](//www.sic.shibaura-it.ac.jp/`sasaki-t/)` <br> 中央大学橋本研究室
:**概要**|
...
<div align="center"><div align="center"><a href="GnuplotViewer.png"><img src="GnuplotViewer.png" width="50%;"></a></div>;</div>
<div align="center"><div align="center"><a href="FunctionGenerator.png"><img src="FunctionGenerator.png" width="50%;"></a></div>;</div>
...
:**概要**|
Android版のRTミドルウェア（RTM on Android）および、そのシステム事例を紹介します。
RTM on Androidを利用することで、Android端末とRTミドルウェアに対応したロボットシステムがシームレスに連携することが可能になります。システム事例では、当社が開発したインフォメーションロボットとAndroid端末を連携し、自動受付システムや防犯システムとして応用可能な遠隔操作・監視ロボットシステムを展示します。

<br>

<div align="center">&ref(RTM on Androidデモ.png,center,50%);</div>


<br>

### OpenRTMによるiPhoneを使ったロボットアームコントロール
****出展者**|[アイ・テー・シー株式会社**: http](//www.itckk.co.jp/)
:**概要**|
...
<table class="table-alt">
  <tr>
    <th>CENTER:<div align="center"><a href="itc1.png"><img src="itc1.png" width="15%;"></a></div>;</th>
  </tr>
  <tr>
    <td>CENTER:**構成図**</td>
  </tr>
...
<div align="center"><a href="iPhoneRemote.png"><img src="iPhoneRemote.png" width="60%;"></a></div>|
<div align="center"><a href="RobotArm.png"><img src="RobotArm.png" width="60%;"></a></div>|
<table class="table-alt">
  <tr>
    <th>CENTER:**iPhoneRemoteコンポーネント**</th>
...
RTC-CANopenは、ネイティブバスであるCANを介して接続されるCANopenに準拠した各種デバイスと
汎用PC上のRTCと相互に接続することが可能となっており、通常のRT-Component同様に管理・操作する事ができます。
...
<div align="center"><div align="center"><a href="RTC-CANopenシステム概要.png"><img src="RTC-CANopenシステム概要.png" width="55%;"></a></div>;</div>
<div align="center"><strong>RTC-CANopenシステム概要</strong></div>
...
:**概要**|
[DAQ-Middleware](http://daqmw.kek.jp) [1]はOpenRTM-aistを基盤とした[高エネルギー加速器研究機構](http://www.kek.jp) （KEK[2]）や[大強度陽子加速器施設](http://j-parc.jp) （J-PARC[3]）等の実験データ収集（DAQ）システムで使用するためのソフトウェアフレームワークである。<br>
RTコンポーネントを拡張したDAQコンポーネントによる汎用で柔軟なDAQシステム構築を目指している。<br>
現在、[J-PARCの物質・生命科学実験施設](http://j-parc.jp/MatLife/ja) （MLF[4]）の複数の実験装置で稼働中のほか各種検出器テストベンチとして使用されている。<br>
:**References**|
1. http://daqmw.kek.jp/
1. http://www.kek.jp/
1. http://j-parc.jp/
...
<div align="center"><div align="center"><a href="daqmw-fig.png"><img src="daqmw-fig.png" width="55%;"></a></div>;</div>
<div align="center"><strong>OpenRTM と ZIPC-RT による「お薬ロボ」の実現例</strong></div>


<br>

### ZIPC-RT
****出展者**|[キャッツ株式会社**: http](//www.zipc.com/)
:**概要**|
想定外な事象への対応モレに追われたことはありませんか？
多数のセンサーから非同期に事象が発生するロボットは、
基本シナリオをカバーするだけでは品質確保できません。
ZIPC-RT は状態遷移表を利用することでロボット開発の
品質確保、生産性向上を支えます。
...
<div align="center"><div align="center"><a href="zipc-rtc.png"><img src="zipc-rtc.png" width="55%;"></a></div>;</div>


<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2008/pw_for_rtm.png,nolink,center); -->
<!-- CENTER:''PatterWeaver for RT-Middleware'' -->
<!-- #br -->
<!--  -->
...
<!-- #br -->
<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/kunii_lab.png,nolink,center,50%); -->
<!-- CENTER:''共有メモリコンポーネントを用いた遠隔可変型ソフトウェアアーキテクチャ'' -->
<!-- #br -->
<!--  -->
<!--  -->
...
<!-- #br -->
<!--  -->
<!-- |CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/ITC_Architecture.png,nolink,center,50%);| -->
<!-- |CENTER:''構成図''| -->
<!--  -->
<!-- | -->
<!-- #ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/ITC_WiiRTC.png,nolink,center,50%)| -->
<!-- #ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/ITC_ArmRTC.png,nolink,center,50%)| -->
<!-- |CENTER:''Wiiコンポーネント''|CENTER:''ロボットアームコンポーネント''| -->
<!--  -->
<!-- #br -->
<!--  -->
<!--  -->
...
<!--  -->
<!-- | -->
<!-- #ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/rt_reuse_center.png,center,20%)| -->
<!-- #ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/rt_reuse_platform.png,center,20%)| -->
<!-- |CENTER:''NEDO知能化プロジェクト・RTC再利用技術研究センター''|CENTER:''RTC再利用技術研究センターで利用可能なロボットプラットフォーム''| -->
<!--  -->
<!-- #br -->
<!--  -->
...
<!-- #br -->
<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/InformationRobot-SEC.png,center,40%); -->
<!-- CENTER:''RTミドルウェア技術を活用したインフォメーションロボットシステム'' -->
<!--  -->
<!-- #br -->
<!--  -->
...
<!-- #br -->
<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/HashimotoLab.jpg,center,90%); -->
<!-- CENTER:''VIRCAによる知能化空間ネットワーク構成図'' -->
<!--  -->
<!-- #br -->
<!--  -->
<!--  -->
<!-- ***株式会社リバストにおけるRTミドルウエア対応の取り組み -->
<!-- :''出展者''|[[株式会社リバスト:http://www.revast.co.jp/]]  -->
<!-- :''概要''| -->
...
<!--  -->
<!-- | -->
<!-- #ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/revast1.png,center,20%)| -->
<!-- #ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/revast2.png,center,20%)| -->
<!-- |CENTER:''対応製品でのRTシステム構成''|CENTER:''対応製品の組み合わせ例''| -->
<!--  -->
<!-- #br -->
<!--  -->
<!-- ***組込み向けRTコンポーネント - TOPPERS版 OpenRTM-aist - -->
<!-- :''出展者''|[[株式会社 未来技術研究所:http://www.ftl.co.jp/index.html]] -->
<!-- :''概要''| -->
...
<!-- #br -->
<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/FTL.png,center,50%); -->
<!-- CENTER:''組込み向けRTコンポーネントの構成例'' -->
<!--  -->
<!-- #br -->
<!--  -->
<!-- ***VxWorks版RTミドルウェアを用いたRTユニット -->
<!-- :''出展者''|[[株式会社 安川電機:http://www.yaskawa.co.jp/]] -->
<!-- :''概要''| -->
...
<!-- #br -->
<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/RTUnit_Yasukawa.png,center,20%); -->
<!-- CENTER:''RTユニットによるロボットシステム'' -->
<!--  -->
<!-- #br -->
<!--  -->
<!-- ***学習・推論コンポーネント -->
<!-- :''出展者''|[[株式会社 アドイン研究所:http://www.adin.co.jp]] -->
<!-- :''概要''| -->
...
<!-- #br -->
<!--  -->
<!-- CENTER:&ref(http://www.openrtm.org/OpenRTM-aist/figs/OpenLab2010/Adin.png,center,50%); -->
<!-- CENTER:''学習・推論コンポーネント利用システム'' -->
<!-- #br -->
