...
[計測自動制御学会(SICE)](http://www.sice.jp)のシステムインテグレーション部門講演会 (SI2021) の特別セッションとしての開催を予定しております。詳細が決まり次第こちらのページでご案内いたします。

- 日時: 2021年 12月15日（水） 13:55−17:10 
- 開催方式: オンライン開催、[oVice会場](https://si2021-s.ovice.in/)
  - [アクセス](https://sice-si.org/conf/si2021/event.html)
<!-- -- オープンフォーラムとなっておりますのでどなたでもご視聴いただけます。 -->
<!-- - 申込締切: 2021年 9月20日（月） -->
<!-- - 原稿〆切: 2021年 10月25日（月） -->
- 参加者：約50名
...
- [共同共催］ [国立研究開発法人産業技術総合研究所](http://www.aist.go.jp/) 
...
<table class="table-alt">
  ...
  <tr>
    <td>1S3-01</td>
    <td>13:55-14:10</td>
    <td>【キーノート】ロボットミドルウェアを用いたソフトウェアモジュールの開発方法について</td>
    <td>産総研・都立大　宮本信彦</td>
    <td>--- ​</td>
  </tr>
  <tr>
...
- [奨励賞登録フォーム](https://forms.gle/uSNtcZ3HceDeoYar7)(googleフォームに移動します)
...
- **9月20日（月）**: エントリ〆切　（SI2021講演申込み〆切）
- **10月25日（火月**: 原稿〆切（SI2021原稿〆切）
- **10月上旬頃**: ホームページにてソフトウエア登録開始（一般ユーザへの公開開始）
<!-- - ''10月31日'': 作品登録締め切り -->
<!-- - ''11月下旬～12月12日'': オンライン評価期間 (一般ユーザによるオンライン評価期間) -->
- **11月下旬～**: オンライン評価期間 (一般ユーザによるオンライン評価期間)
- **12月15日**: SI2021会場にて、プレゼンテーションと表彰者発表　
- **12月17日**: SI2021授賞式にて最優秀者表彰

### 応募手順

- [SI2021への発表申込](https://sice-si.org/conf/si2021/)
<!-- https://ssl.si-sice.org/si2017/sys/reg_login.html -->
申込セッションとして「特別OS：RTミドルウエアコンテスト2021」、講演の種類として「一般講演」をそれぞれ選択し、講演題目のところに開発したRTコンポーネントや関連技術の名称を、著者のところに開発者の情報をそれぞれ記入お願いいたします。学生さんがエントリする場合は**事前に指導教員の了承**を得るとともに、指導教員を共著者として登録いただくようお願いいたします。~
※申し込み締切日が決まってますので、**エントリー登録を決意した方はSI2021の講演申し込みを先に進めてください**。

- [SI2021への予稿原稿の投稿](https://sice-si.org/conf/si2021/)（10月26日締切）~ 
投稿規定に従って、講演予稿集のための2～6ページの原稿を作成し、投稿ください。
- [SI2021への参加登録](https://sice-si.org/conf/si2021/) ~
...
が必要となります。特に、SI2021への参加には参加登録料が必要となりますことを予めご了承ください。また、SI2021の会場にてプレゼンテーションを行うことが求められます。
SI2021の申込方法、申込および原稿〆切および具体的な開催日時やプログラムは [SI2021のホームページ](https://sice-si.org/conf/si2021/) にてご確認下さい。
...
1. ボキャブラリ **RTM contest 2021** を設定する
  - プロジェクト登録画面にボキャブラリと呼ばれるタグを設定する画面が現れますが、そこで **RTM contest 2021** を選択してください。これによりRTMコンテスト参加作品であることがわかります。
...
1. プロジェクト情報「Short project name」をcontest2021_<番号>としてください．
...
http://openrtm.org/openrtm/ja/project/contest2021_X
となります。
...
RTミドルウエアコンテスト事務局: rtm-contest<at>aist.go.jp, rtmcontest2021<at>openrtm.org
