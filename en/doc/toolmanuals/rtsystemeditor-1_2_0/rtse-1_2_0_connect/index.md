...
<table class="table-alt">
  ...
  <tr>
    ...
    <td>―</td>
    <td>
接続するサービスポートに設定されたインターフェースの Consumer のリストから選択します。
...
<br>
<ul>
<li>rtc_nameはコンポーネント名</li>
<li>port_name はポート名</li>
<li>if_polalityは Consumer は「required」、Provider は「provided」</li>
<li>if_tnameはインターフェースのタイプ名</li>
<li>if_inameはインターフェースのインスタンス名</li>
</ul>
</td>
  </tr>
  <tr>
