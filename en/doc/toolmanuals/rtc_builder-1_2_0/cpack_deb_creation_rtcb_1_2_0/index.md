...
The procedure for creating a deb package is shown below.<br>
...
## deb Package Storage Location and File Name
If it is created successfully, it will be saved in [build] under the project directory.<br>
The file name will be "RTC project name_RTC version number_architecture".<br>

(Example) Flip_1.2.0_amd64.deb<br>
* The architecture will be [i386] or [amd64].<br>

## How to Check a deb Package
- When checking a deb package with the less command
...
- When extracting and checking the contents of a deb package<br>
...
The following is a list of files installed from the deb package. Files marked with ★ are generated by IDL compilation. 
```
