...
## Overview
Terminates a running RT Component. The component terminates after performing shutdown processing such as related callbacks and resource release.
...
## Example
- Terminates the ConsoleOut0.rtc component.
```
