...
<div align="center"><strong>File メニューから Open New Builder Editor</strong></div>
...
- 実行周期: 0.0 (<span style="color:RED;">下図では 1.0 となってますが、0.0 としてください.</span>;)
...
<div align="center"><strong>CMakeLists.txtの指定</strong></div>
...
<table class="table-alt">
  <tr>
    <th><strong>Where is the soruce code**</strong></th>
    <th>C:\rtcws\Flip</th>
  </tr>
  <tr>
...
<div align="center"><strong>ビルド画面</strong></div>
...
<div align="center"><strong>CMakeLists.txt の編集</strong></div>
...
<span style="color:RED;">※ Eclipse 起動時に workspace をデフォルトのままにしていた場合、Flipフォルダーのパスは、</span>;
