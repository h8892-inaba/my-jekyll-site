...
- [Binary packages:ftp]()(No corresponding page available.)
...
OpenRTM-aist で必要な omniORB も上述の[配布サイト:ftp]()(No corresponding page available.)にはバイナリパッケージが無いため、openrtm.org で提供されています。
...
<div align="center"><a href="qnx_test.png"><img src="qnx_test.png" width="70%;"></a></div>
<div align="center"><strong>QNX上で動作する ConsoleIn と ConsoleOut コンポーネント</strong></div>
